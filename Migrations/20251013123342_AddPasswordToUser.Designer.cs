...
namespace app_ointment_backend.Migrations
{
    ...
    [Migration("20251013123342_AddPasswordToUser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("app_ointment_backend.Models.AppointmentTask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("app_ointment_backend.Models.AvailableDay", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("app_ointment_backend.Models.Appointment", b =>
                {
                    b.HasOne("app_ointment_backend.Models.User", "ElderlyUser")
                        .WithMany("Appointments")
                        .HasForeignKey("ElderlyUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("app_ointment_backend.Models.User", "HealthcarePersonnel")
                        .WithMany()
                        .HasForeignKey("HealthcarePersonnelId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("ElderlyUser");
            ...
            modelBuilder.Entity("app_ointment_backend.Models.AppointmentTask", b =>
                {
                    b.HasOne("app_ointment_backend.Models.Appointment", "Appointment")
                        .WithMany("Tasks")
